...
public class BackOfficeVerifyImpl {
	...
	public String doBalanceCheck(String tiRequestXML) {
		...
		BOCCommonUtil.insertTIReqToLogTable(tiRequestXML, Constants.BALANCE_CHECK_STAGING_TABLE,
		...
		BOCCommonUtil.updateReferenceinLog(
				...
				Constants.BALANCE_CHECK_STAGING_TABLE, pkey);
		...
		BOCCommonUtil.updateTIResToLogTable(tiResponseXML, Constants.BALANCE_CHECK_STAGING_TABLE,
	...
	private BackOfficeVerifyTIResponseModel setTIResModelFromBankResModel(
		...
		if (!CommonUtil.NullStringCheck(masterCode) && !CommonUtil.NullStringCheck(eventCode)) {
			if ((masterCode.equalsIgnoreCase("ILC") && eventCode.equalsIgnoreCase("POC"))
					...
					|| (masterCode.equalsIgnoreCase("ELC") && eventCode.equalsIgnoreCase("POD"))
					|| (masterCode.equalsIgnoreCase("ODC") && eventCode.equalsIgnoreCase("PAY"))
					|| (masterCode.equalsIgnoreCase("FEL") && eventCode.equalsIgnoreCase("RFS"))
					|| (masterCode.equalsIgnoreCase("FOC") && eventCode.equalsIgnoreCase("RFS"))
					) {
			...
			if (AccStatus && isBalAvail) {
				...
				if (aBackOfficeVerifyBankReqModel.get(i).getAcctType()
					...
					// Same BOCM quiery used as per the given instructions by BOC.
						...
						.equalsIgnoreCase(BOCCommonUtil.retreiveFromProperties(Constants.CURRENT_ACCOUNT))) || (zone.equals("BOCS") && aBackOfficeVerifyBankReqModel.get(i).getAcctType()
								.equalsIgnoreCase(BOCCommonUtil.retreiveFromProperties(Constants.CURRENT_ACCOUNT))) ) {
					System.out.println("Zone 3 & Zone 4 Balence Check");
					if (aBackOfficeVerifyBankReqModel.get(i).getPostCcy()
							.equalsIgnoreCase(BOCCommonUtil.retreiveFromProperties(Constants.LOCAL_CURRENCY))
							|| aBackOfficeVerifyBankReqModel.get(i).getPostCcy()
	...
	public static void main(String[] args) {
		BackOfficeVerifyImpl b = new BackOfficeVerifyImpl();
