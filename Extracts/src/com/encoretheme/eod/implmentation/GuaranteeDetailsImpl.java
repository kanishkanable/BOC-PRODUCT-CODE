...
public class GuaranteeDetailsImpl {
	public static Logger logger = Logger.getLogger(GuaranteeDetailsImpl.class);
	...
	//	Properties aProperties = new Properties(); Rajwin_Modified
		...
		//	aProperties = ExtractsPropertyUtil.getPropertiesValue();
			...
			if (connection != null) {
				String query = QueryConstant.guarantee_link_details;
				...
				StringBuffer finalString = BOCCommonUtil.prepareAsFilewithPipeline(resultSet,
						Constants.guarantee_details_header);         // Rajwin_Modified
