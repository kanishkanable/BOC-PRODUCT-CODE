...
public class CollateralLinkDetailsImpl {
	public static Logger logger = Logger.getLogger(CollateralLinkDetailsImpl.class);
	...
	//	Properties aProperties = new Properties(); Rajwin_Modified
		...
		//	aProperties = ExtractsPropertyUtil.getPropertiesValue();
			...
			if (connection != null) {
				String query = QueryConstant.collateral_link_details;
				...
				StringBuffer finalString = BOCCommonUtil.prepareAsFilewithPipeline(resultSet,
						Constants.collateral_link_details_header);         // Rajwin_Modified
