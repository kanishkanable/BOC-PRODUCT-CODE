...
public class CollateralDetailsImpl {
	public static Logger logger = Logger.getLogger(CollateralDetailsImpl.class);
		...
		//	aProperties = ExtractsPropertyUtil.getPropertiesValue();
			...
			if (connection != null) {
				...
				StringBuffer finalString = BOCCommonUtil.prepareAsFilewithPipeline(resultSet,
						Constants.collateral_details_header);         // Rajwin_Modified
