...
public class MarginDepositImpl {
	public static Logger logger = Logger.getLogger(MarginDepositImpl.class);
	...
	//	Properties aProperties = new Properties(); Rajwin_Modified
		...
		//	aProperties = ExtractsPropertyUtil.getPropertiesValue();
			...
			if (connection != null) {
				String query = QueryConstant.margindeposit;
				...
				StringBuffer finalString = BOCCommonUtil.prepareAsFilewithPipeline(resultSet,
						Constants.Margin_Deposit_Header);         // Rajwin_Modified
