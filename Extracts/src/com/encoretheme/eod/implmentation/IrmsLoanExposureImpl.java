...
public class IrmsLoanExposureImpl {
	public static Logger logger = Logger.getLogger(IrmsLoanExposureImpl.class);
	...
	//	Properties aProperties = new Properties(); Rajwin_Modified
		...
		//	aProperties = ExtractsPropertyUtil.getPropertiesValue();
			...
			if (connection != null) {
				String query = QueryConstant.LOAN_EXPOSURE;
				...
				StringBuffer finalString = BOCCommonUtil.prepareAsFilewithPipeline(resultSet,
						Constants.LOAN_EXPOSURE_HEADER);         // Rajwin_Modified
