...
public class CounterPartyDeduction  implements com.misys.tiplus2.enigma.job.BatchUserExitAction {
	...
	public UserExitActionStatus run(Long arg0, String arg1, StepContext arg2){
		...
		String Satus="";
		Satus=coldt.extract("Counter_Party_Deduction", "Counterparty_deduction_header",
				"destinationFilePath");
