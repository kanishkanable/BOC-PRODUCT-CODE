...
import com.encoretheme.eod.implmentation.OverOneMillionRecordImpl;
...
public class OverOneMillionRecord implements com.misys.tiplus2.enigma.job.BatchUserExitAction{
	
	public static Logger logger = Logger.getLogger(OverOneMillionRecord.class);
	public static void main(String[] args)
	{		
		System.out.println("Main Method in EOD");
		logger.info("Main Method in EOD");
	
		new OverOneMillionRecord().run (0L,"0",(StepContext)null);
	...
	public UserExitActionStatus run(Long arg0, String arg1, StepContext arg2){
		...
		Satus=coldt.extract("OVERMILLIONRECORD", "OVERMILLIONRECORD_HEADER",
				"destinationFilePath");
