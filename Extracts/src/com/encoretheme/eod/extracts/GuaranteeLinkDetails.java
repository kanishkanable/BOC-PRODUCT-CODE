...
import com.encoretheme.eod.implmentation.GuaranteeLinkDetailsImpl;
...
public class GuaranteeLinkDetails implements com.misys.tiplus2.enigma.job.BatchUserExitAction{
	...
	public UserExitActionStatus run(Long arg0, String arg1, StepContext arg2){
		GuaranteeLinkDetailsImpl coldt = new GuaranteeLinkDetailsImpl();
		String Satus="";
