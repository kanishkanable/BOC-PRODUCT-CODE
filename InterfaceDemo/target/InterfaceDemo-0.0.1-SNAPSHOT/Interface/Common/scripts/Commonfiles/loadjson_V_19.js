     ...
     /*   if (typeof hdncolumn != "undefined") {
            ...
            for (var iii = 0; iii < count; iii++) {
                ...
                footervalue += '<td><input type="button" name="search_engine" style="width:15px"  class="search_init" /></td>';
					...
					HeaderBtnval +='&nbsp;&nbsp;&nbsp;<img class="buttonPRS" id="Save" style ="width:25px; height:20px;" title="Insert" type="button" src=\"/ThemePro_LSW/ThemeproLO/Common/Images/check1.png\"/>  (Click to insert)'
   ...
   // myData = JSON.parse(result.d);
    ...
    if (typeof popTable === "undefined" || popTable === null) {
     ...
     /*   if (typeof hdncolumn != "undefined") {
        ...
        footervalue += '<td><a type="button" name="search_engine" id="" title="Add" style="width:20px;height:20px;" ><img id="GridAdd" name="'+TableID+'" style="width:20px;height:20px;" class="Table2 NewProcess" src="SBIReimbursement/Common/Images/file_add.png"></a></td>';
*/
        footervalue += '<td><a type="button" name="search_engine" id="" title="Add" style="width:20px;height:20px;" ></a></td>';
            footervalue = '<tfoot><tr>' + footervalue + '</tr><tfoot>';
            //$("#Table1_length").append('<input id="checkvalueexist" value="search" type="button"/>');
            //$("#Table1_length").append('<input id="checkvalueexist" value="search" type="button"/>');
