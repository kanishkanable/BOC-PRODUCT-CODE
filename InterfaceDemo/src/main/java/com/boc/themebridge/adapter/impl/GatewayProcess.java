		...
		try {
			for (TiGateWayExtractLog tiGateWayExtractLog : gatewayList) {
				...
				if (updateCount > 0) {
					...
					procedureList.add("OVER_ONE_MILLIONs");
					//DATAWAREHOUSE
					procedureList.add("DATAWAREHOUSE_ALL_PROC");
					procedureList.add("DATAWAREHOUSE_FINANCINGNPA_PROC");
					procedureList.add("DATAWAREHOUSE_NOSTRO_PROC");
					procedureList.add("DATAWAREHOUSE_OTHER_PROC");
