...
<script type="text/javascript">
	...
	function custlist(event) {
		...
		if (id == undefined) {
			...
			var test = id.split('_');
			var val = test[1];
			var test1 = $("#brncode_" + val).attr('id');
			var value_key1 = $("#" + test1).val();
			$('#branchCode').val($.trim(value_key1));
						...
						<div class="col-md-12">
							<div class="row page_content">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-6 input-group input-group-md">
											<branchSelection:textfield id="branchCode"
												name="slcustomVO.branchCode"
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="col-md-4 Control-label"
											style="font-weight: normal;">Branch Name</label>
										<div class="col-md-6 input-group input-group-md">
											<branchSelection:textfield id="branchName"
												name="slcustomVO.branchName"
												cssClass="form-control text_box" />
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-6 input-group input-group-md">
											<branchSelection:textfield id="branchCity"
												name="slcustomVO.branchCity"
												cssClass="form-control text_box" />
											...
											<div class="form-group">
												...
												<div class="col-md-4 input-group input-group-md">
													<branchSelection:submit name="refreshsbrh"
														action="fetchBranchDetails" cssClass="button-new"
									...
									<div class="form-group"
										...
										<table border="1px" align="left"
											...
											<tbody>
												<tr>
													<th
														style="padding: 4px 5px; font-weight: bold; position: sticky; top: 0;"><label>Branch
															Code</label></th>
													<th
														style="padding: 4px 5px; font-weight: bold; position: sticky; top: 0;"><label>Branch
															Name Name</label></th>
													<th
														style="padding: 4px 5px; font-weight: bold; position: sticky; top: 0;"><label>City</label></th>

													<th
														style="padding: 4px 5px; font-weight: bold; position: sticky; top: 0;"><label>Country</label></th>

												</tr>
												<branchSelection:iterator value="branchDetailsList"
													status="status">
													<tr style="backtfboound: maroon;" class="eventrefresh"
														id='branchDetailsList_<branchSelection:property value="%{#status.count}"/>'
														onClick="selectlister(this)" ondblclick="custlist(this);">
														<td
															style="text-align: left; padding: 4px 5px; width: 200px;">
															<div class="form-group" align="left">
																<branchSelection:property value="brncode" />
																<div class="col-md-8 input-group input-group-md"></div>
															</div>
														</td>
														<td style="text-align: left; padding: 4px 5px;">
															<div class="form-group" align="left">
																<branchSelection:property value="brnName" />
																<div class="col-md-8 input-group input-group-md"></div>
															</div>
														</td>
														<td style="text-align: left; padding: 4px 5px;">
															<div class="form-group" align="left">
																<branchSelection:property value="brnCity" />
																<div class="col-md-8 input-group input-group-md"></div>
															</div>
														</td>
														<td style="text-align: left; padding: 4px 5px;">
															<div class="form-group" align="left">
																<branchSelection:property value="brnCountry" />
																<div class="col-md-8 input-group input-group-md"></div>
															</div>
														</td>

														<branchSelection:hidden id='%{"brncode_" + #status.count}'
															value="%{brncode}" />
