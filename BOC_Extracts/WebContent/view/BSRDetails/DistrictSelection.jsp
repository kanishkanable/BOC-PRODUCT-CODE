...
<script type="text/javascript">
	...
	function districtList(event) {
		$(".districtList").removeClass("highlighted");
		$(event).addClass("highlighted");
		var districtCode = $(event).find("td").eq(1).text().trim();
		$('#districtCodeGridValue').val(districtCode);
				...
				<div class="row page_content">
					<div class="col-md-12">
						<div class="page_collapsible collapse-open" id="body-section1">
							<span></span>
							<h5 style="font-weight: bold; font-size: 13px;">&nbsp;District
								Search</h5>
						</div>
							...
							<div class="row page_content">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-6 input-group input-group-md">
											<extracts:textfield id="districtNameFilter"
												name="bsrLookupVo.districtNameFilter"
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="col-md-4 Control-label"
											style="font-weight: normal;"><extracts:text
												name="District Code" /></label>
										<div class="col-md-6 input-group input-group-md">
											<extracts:textfield id="districtCodeFilter"
												name="bsrLookupVo.districtCodeFilter"
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-4 input-group input-group-md">
											<extracts:submit name="refreshDistrictDetails"
												id="refreshDistrictDetails" action="fetchDistrictDetails"
												value="Refresh"></extracts:submit>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="form-group"
							...
							<table border="1px" align="left"
								...
								<tbody>
									<tr>
										<th
											style="padding: 4px 5px; width: 500px; font-weight: bold; position: sticky; top: 0;"><label>District</label></th>
										<th
											style="padding: 4px 5px; font-weight: bold; position: sticky; top: 0;"><label>District
												Code</label></th>

									</tr>
									<extracts:iterator value="districtList" status="status">

										<tr style="backtfboound: maroon;" class="eventrefresh"
											id='districtList_<extracts:property value="%{#status.count}"/>'
											onClick="selectlister(this)" ondblclick="districtList(this);">

											<td style="text-align: left; padding: 4px 5px; width: 500px;">
												<div class="form-group" align="left">
													<extracts:property value="districtName" />
											...
											<td style="text-align: left; padding: 4px 5px;">
												<div class="form-group" align="left">
													<extracts:property value="districtCode" />
													<div class="col-md-8 input-group input-group-md"></div>
												</div>
											</td>
					...
					<extracts:hidden id="districtCodeGridValue"
