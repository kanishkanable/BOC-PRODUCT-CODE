...
<title>Secured Un-Secured Loan Search</title>
...
<script type="text/javascript">
	...
	function secUnsecLoanCodeList(event) {
		$(".secUnsecLoanCodeList").removeClass("highlighted");
		$(event).addClass("highlighted");
		var secUnsecLoanCode = $(event).find("td").eq(1).text().trim();
		$('#secUnsecLoanCodeGridValue').val(secUnsecLoanCode);
				...
				<div class="row page_content">
					<div class="col-md-12">
						<div class="page_collapsible collapse-open" id="body-section1">
							<span></span>
							<h5 style="font-weight: bold; font-size: 13px;">&nbsp;Secured/
								Un-Secured Loan Search</h5>
						</div>
									...
									<div class="form-group">
										<label class="col-md-4 Control-label"
											style="font-weight: normal;"><extracts:text
												name="Type of Security" /></label>
										<div class="col-md-6 input-group input-group-md">
											<extracts:textfield id="securityTypeFilter"
												name="bsrLookupVo.securityTypeFilter"
									...
									<div class="form-group">
										<label class="col-md-4 Control-label"
											style="font-weight: normal;"><extracts:text
												name="Code" /></label>
										<div class="col-md-6 input-group input-group-md">
											<extracts:textfield id="securityTypeCodeFilter"
												name="bsrLookupVo.securityTypeCodeFilter"
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-4 input-group input-group-md">
											<extracts:submit name="refreshSecUnsecLoanCodeDetails"
												id="refreshSecUnsecLoanCodeDetails"
												action="fetchSecUnsecLoanCodeDetails" value="Refresh"></extracts:submit>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="form-group"
							...
							<table border="1px" align="left"
								...
								<tbody>
									<tr>
										<th
											style="padding: 4px 5px; width: 500px; font-weight: bold; position: sticky; top: 0;"><label>Type
												of Security</label></th>
										<th
											style="padding: 4px 5px; font-weight: bold; position: sticky; top: 0;"><label>Code</label></th>

									</tr>
									<extracts:iterator value="secUnsecLoanCodeList" status="status">

										<tr style="backtfboound: maroon;" class="eventrefresh"
											id='secUnsecLoanCodeList_<extracts:property value="%{#status.count}"/>'
											onClick="selectlister(this)"
											ondblclick="secUnsecLoanCodeList(this);">

											<td style="text-align: left; padding: 4px 5px; width: 500px;">
												<div class="form-group" align="left">
													<extracts:property value="securityType" />
											...
											<td style="text-align: left; padding: 4px 5px;">
												<div class="form-group" align="left">
													<extracts:property value="securityTypeCode" />
													<div class="col-md-8 input-group input-group-md"></div>
												</div>
											</td>
										</tr>
					...
					<extracts:hidden id="secUnsecLoanCodeGridValue"
