...
<script type="text/javascript">
	function customerSelection() {
		$("#formId").attr("action", "customerSearch");
		$("#formId").submit();
	}
	function fetchCustomerLimitDetails() {
		var id = document.getElementById("customerID").innerHTML; //innerHTML
				...
				<div class="row page_content">
					<div class="col-md-12">
						<div class="page_collapsible collapse-open" id="body-section1">
							<span></span>
							<h5 style="font-weight: bold; font-size: 13px;">&nbsp;BSR
								Details</h5>
						</div>
									...
									<div class="form-group">
										<div class="col-md-4 input-group input-group-md">
											<extracts:submit name="refreshLimits" id="refreshLimits"
												cssClass="fetchButton" onclick="fetchCustomerLimitDetails()"
						...
						<div class="form-group"
							...
							<table border="1px" align="left"
								...
								<tbody>
									<tr>
										<th
											style="padding: 4px 5px; width: 300px; font-weight: bold; position: sticky; top: 0;"><label>Category
												Description</label></th>
										<th
											style="padding: 4px 5px; width: 300px; font-weight: bold; position: sticky; top: 0;"><label>Limit</label></th>
										<th
											style="padding: 4px 5px; width: 300px; font-weight: bold; position: sticky; top: 0;"><label>Currency</label></th>
										<th
