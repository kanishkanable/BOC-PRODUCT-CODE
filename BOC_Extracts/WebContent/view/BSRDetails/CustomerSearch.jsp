...
<script type="text/javascript">
	...
	function custlist(event) {
		...
		if (id == undefined) {
			...
			var idResult = id.split('_');
			var idResultValue = idResult[1];
			var customerMnemonic = $("#custMnemonic_" + idResultValue).attr(
					'id');
			var customerMnemonicValue = $("#" + customerMnemonic).val();
			$('#mnemonic').val($.trim(customerMnemonicValue));
							...
							<div class="row page_content">
								<div class="col-md-6">
									<div class="form-group">
										<label class="col-md-4 Control-label"
											style="font-weight: normal;"><extracts:text
												name="Country" /><a href="#" onclick="countrySearch()"><img
									...
									<div class="form-group">
										...
										<div class="col-md-4 input-group input-group-md">
											<extracts:submit name="refreshCust" id="refreshCust"
												action="customerDetailsSearch" value="Refresh"></extracts:submit>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="form-group"
							...
							<table border="1px" align="left"
								...
								<tbody>
									<tr>
										<th
											style="padding: 4px 5px; width: 200px; font-weight: bold; position: sticky; top: 0;"><label>Mnemonic</label></th>
										<th
											style="padding: 4px 5px; width: 200px; font-weight: bold; position: sticky; top: 0;"><label>Full
												Name</label></th>
										<th
											style="padding: 4px 5px; width: 130px; font-weight: bold; position: sticky; top: 0;"><label>Location</label></th>
										<th
											style="padding: 4px 5px; width: 130px; font-weight: bold; position: sticky; top: 0;"><label>Number</label></th>
										<th
											style="padding: 4px 5px; width: 130px; font-weight: bold; position: sticky; top: 0;"><label>Group</label></th>
										<th
											style="padding: 4px 5px; width: 130px; font-weight: bold; position: sticky; top: 0;"><label>Country</label></th>
										<th
											style="padding: 4px 5px; width: 130px; font-weight: bold; position: sticky; top: 0;"><label>Account
												Officer</label></th>
										<th
									...
									<extracts:iterator value="custDetailsList" status="status">
										...
										<tr style="backtfboound: maroon;" class="eventrefresh"
											...
											<td style="text-align: left; padding: 4px 5px; width: 130px;">
												<div class="form-group" align="left">
