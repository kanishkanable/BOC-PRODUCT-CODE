...
<title>Category of Borrower Search</title>
...
<script type="text/javascript">
	...
	function categoryBorrowerCodeList(event) {
		$(".categoryBorrowerCodeList").removeClass("highlighted");
		$(event).addClass("highlighted");
		var categoryofBorrowerCode = $(event).find("td").eq(1).text().trim();
		$('#categoryofBorrowerCodeGridValue').val(categoryofBorrowerCode);
				...
				<div class="row page_content">
					<div class="col-md-12">
						<div class="page_collapsible collapse-open" id="body-section1">
							<span></span>
							<h5 style="font-weight: bold; font-size: 13px;">&nbsp;Category
								of Borrower Search</h5>
						</div>
									...
									<div class="form-group">
										<label class="col-md-4 Control-label"
											style="font-weight: normal;"><extracts:text
												name="Category of Borrower" /></label>
										<div class="col-md-6 input-group input-group-md">
											<extracts:textfield id="categoryBorrowerFilter"
												name="bsrLookupVo.categoryBorrowerFilter"
									...
									<div class="form-group">
										<label class="col-md-4 Control-label"
											style="font-weight: normal;"><extracts:text
												name="Code" /></label>
										<div class="col-md-6 input-group input-group-md">
											<extracts:textfield id="categoryBorrowerCodeFilter"
												name="bsrLookupVo.categoryBorrowerCodeFilter"
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-4 input-group input-group-md">
											<extracts:submit name="refreshCategoryBorrowerCodeDetails"
												id="refreshCategoryBorrowerCodeDetails"
												action="fetchCategoryBorrowerCodeDetails" value="Refresh"></extracts:submit>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="form-group"
							...
							<table border="1px" align="left"
								...
								<tbody>
									<tr>
										<th
											style="padding: 4px 5px; width: 500px; font-weight: bold; position: sticky; top: 0;"><label>Category
												of Borrower</label></th>
										<th
											style="padding: 4px 5px; font-weight: bold; position: sticky; top: 0;"><label>Code</label></th>

									</tr>
									<extracts:iterator value="categoryBorrowerCodeList"
										status="status">
										<tr style="backtfboound: maroon;" class="eventrefresh"
											id='categoryBorrowerCodeList_<extracts:property value="%{#status.count}"/>'
											onClick="selectlister(this)"
											ondblclick="categoryBorrowerCodeList(this);">

											<td style="text-align: left; padding: 4px 5px; width: 500px;">
												<div class="form-group" align="left">
													<extracts:property value="categoryBorrower" />
											...
											<td style="text-align: left; padding: 4px 5px;">
												<div class="form-group" align="left">
													<extracts:property value="categoryBorrowerCode" />
													<div class="col-md-8 input-group input-group-md"></div>
												</div>
											</td>
										</tr>
					...
					<extracts:hidden id="categoryofBorrowerCodeGridValue"
