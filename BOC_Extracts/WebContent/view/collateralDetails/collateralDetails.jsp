...
<script type="text/javascript">
	...
	function limitList(event) {
		...
		if (id == undefined) {
			...
			$("#formId").attr("action", "attachCollateral");
			$("#formId").submit();
		}
	}
							...
							<table border="1px" align="left"
								...
								<tbody>
									<tr>
										...
										<th
											style="padding: 3px 3px; font-weight: bold; position: sticky; top: 0;"><label>Status</label></th>
									</tr>
									<extracts:iterator value="customerLimitList"
										...
										<tr style="backtfboound: maroon;" class="eventrefresh"
											...
											<td style="text-align: left; padding: 3px 3px;">
												<div class="form-group" align="left">
