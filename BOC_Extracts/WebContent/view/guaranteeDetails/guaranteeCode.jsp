...
<title>Guarantee type code</title>
...
<script type="text/javascript">
	...
	function codelist(event) {
		...
		if (id == undefined) {
			...
			$('#guaranteeType').val($.trim(value_key1));
			$('#guaranteeDescription').val($.trim(value_key2));
			$("#formId").attr("action", "returnGuarantee");
			$("#formId").submit();
		}
	}
	function formclose() {
...
<body class="body_bg">
	<branchSelection:form method="post" id="formId" name="form">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="col-md-4 Control-label"
										style="font-weight: normal;">Guarantee code *</label>
					...
					<div class="col-md-12">
						<div class="row page_content">
							<div class="col-md-6">
								<div class="form-group">
									<label class="col-md-4 Control-label"
										style="font-weight: normal;">Guarantee Description</label>
									<div class="col-md-6 input-group input-group-md">
								...
								<div class="form-group">
									...
									<div class="col-md-4 input-group input-group-md">
										<branchSelection:submit name="refreshsbrh"
											action="fetchGuaranteeCodeDetails" cssClass="button-new"
						...
						<div class="form-group"
							...
							<table border="1px" align="left"
								...
								<tbody>
									<tr>
										<th
											style="padding: 4px 5px; font-weight: bold; position: sticky; top: 0;"><label>Guarantee
												code</label></th>
										<th
											style="padding: 4px 5px; font-weight: bold; position: sticky; top: 0;"><label>Guarantee
									...
									<branchSelection:iterator value="guaranteeCodeDetailsList"
										status="status">
										<tr style="backtfboound: maroon;" class="eventrefresh"
											id='guaranteeCodeDetailsList_<branchSelection:property value="%{#status.count}"/>'
		...
		<branchSelection:hidden id='guaranteeType'
			name="guaVO.guaranteeTypeCode" />
		<branchSelection:hidden id='guaranteeDescription'
			name="guaVO.guaranteeDescription" />
		<branchSelection:hidden name="guaVO.guaranteeNumber" />
		...
		<branchSelection:hidden name="guaVO.counterpartyUniqueIdentifier" />
		<branchSelection:hidden name="guaVO.providerUniqueIdentifier" />
		<branchSelection:hidden name="guaVO.guaranteeNature" />
		<branchSelection:hidden name="guaVO.guaranteeAmount" />
		<branchSelection:hidden name="guaVO.currencyCode" />
		<branchSelection:hidden name="guaVO.branchCode" />
		<branchSelection:hidden name="guaVO.issueDate" />
		<branchSelection:hidden name="guaVO.maturitydate" />
		<branchSelection:hidden name="guaVO.receivedDate" />
		<branchSelection:hidden name="guaVO.natureOfLimit" />
		<branchSelection:hidden name="guaVO.narrative" />
